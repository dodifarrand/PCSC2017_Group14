...
The predefine main allows the user to interact with a small program that gives the results wanted.
...
\textbf{Readfile (class)}: This class creates an object that instatiate the class Approximation.
